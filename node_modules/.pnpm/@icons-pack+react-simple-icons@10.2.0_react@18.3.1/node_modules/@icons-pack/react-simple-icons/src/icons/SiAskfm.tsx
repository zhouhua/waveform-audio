    ...
    type SiAskfmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#DB3552';

    const SiAskfm: IconType = React.forwardRef<SVGSVGElement, SiAskfmProps>(function SiAskfm({title = 'ASKfm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAskfm as default, defaultColor };
