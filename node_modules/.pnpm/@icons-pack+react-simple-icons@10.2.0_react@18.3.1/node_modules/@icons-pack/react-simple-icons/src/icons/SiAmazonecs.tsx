    ...
    type SiAmazonecsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonecs: IconType = React.forwardRef<SVGSVGElement, SiAmazonecsProps>(function SiAmazonecs({title = 'Amazon ECS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
