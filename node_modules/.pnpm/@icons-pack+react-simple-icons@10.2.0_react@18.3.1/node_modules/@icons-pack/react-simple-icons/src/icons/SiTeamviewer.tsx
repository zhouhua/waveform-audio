    ...
    type SiTeamviewerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTeamviewer: IconType = React.forwardRef<SVGSVGElement, SiTeamviewerProps>(function SiTeamviewer({title = 'TeamViewer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
