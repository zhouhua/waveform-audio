    ...
    type SiGooglefitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglefit: IconType = React.forwardRef<SVGSVGElement, SiGooglefitProps>(function SiGooglefit({title = 'Google Fit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
