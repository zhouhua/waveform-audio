    ...
    type SiAmazonprimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonprime: IconType = React.forwardRef<SVGSVGElement, SiAmazonprimeProps>(function SiAmazonprime({title = 'Amazon Prime', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonprime as default, defaultColor };
