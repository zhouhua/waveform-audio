    ...
    type SiAdobepremiereproProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobepremierepro: IconType = React.forwardRef<SVGSVGElement, SiAdobepremiereproProps>(function SiAdobepremierepro({title = 'Adobe Premiere Pro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
