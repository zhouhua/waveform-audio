    ...
    type SiTutanotaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTutanota: IconType = React.forwardRef<SVGSVGElement, SiTutanotaProps>(function SiTutanota({title = 'Tutanota', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
