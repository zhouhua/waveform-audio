    ...
    type SiAdobephotoshopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobephotoshop: IconType = React.forwardRef<SVGSVGElement, SiAdobephotoshopProps>(function SiAdobephotoshop({title = 'Adobe Photoshop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
