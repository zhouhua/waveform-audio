    ...
    type SiAmazonsimpleemailserviceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonsimpleemailservice: IconType = React.forwardRef<SVGSVGElement, SiAmazonsimpleemailserviceProps>(function SiAmazonsimpleemailservice({title = 'Amazon Simple Email Service', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonsimpleemailservice as default, defaultColor };
