    ...
    type SiD3dotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiD3dotjs: IconType = React.forwardRef<SVGSVGElement, SiD3dotjsProps>(function SiD3dotjs({title = 'D3.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
