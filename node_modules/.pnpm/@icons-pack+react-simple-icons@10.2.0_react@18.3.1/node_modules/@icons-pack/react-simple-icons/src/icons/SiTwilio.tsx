    ...
    type SiTwilioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTwilio: IconType = React.forwardRef<SVGSVGElement, SiTwilioProps>(function SiTwilio({title = 'Twilio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTwilio as default, defaultColor };
