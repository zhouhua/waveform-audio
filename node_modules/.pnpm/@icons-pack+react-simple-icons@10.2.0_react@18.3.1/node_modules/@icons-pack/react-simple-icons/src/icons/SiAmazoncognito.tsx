    ...
    type SiAmazoncognitoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazoncognito: IconType = React.forwardRef<SVGSVGElement, SiAmazoncognitoProps>(function SiAmazoncognito({title = 'Amazon Cognito', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
