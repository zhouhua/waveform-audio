    ...
    type SiAdobelightroomclassicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobelightroomclassic: IconType = React.forwardRef<SVGSVGElement, SiAdobelightroomclassicProps>(function SiAdobelightroomclassic({title = 'Adobe Lightroom Classic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdobelightroomclassic as default, defaultColor };
