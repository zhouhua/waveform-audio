    ...
    type SiAwslambdaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAwslambda: IconType = React.forwardRef<SVGSVGElement, SiAwslambdaProps>(function SiAwslambda({title = 'AWS Lambda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
