    ...
    type SiAdobeauditionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobeaudition: IconType = React.forwardRef<SVGSVGElement, SiAdobeauditionProps>(function SiAdobeaudition({title = 'Adobe Audition', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
