    ...
    type SiAlteryxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0078C0';

    const SiAlteryx: IconType = React.forwardRef<SVGSVGElement, SiAlteryxProps>(function SiAlteryx({title = 'Alteryx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlteryx as default, defaultColor };
