    ...
    type SiAwssecretsmanagerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAwssecretsmanager: IconType = React.forwardRef<SVGSVGElement, SiAwssecretsmanagerProps>(function SiAwssecretsmanager({title = 'AWS Secrets Manager', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
