    ...
    type SiCliqzProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCliqz: IconType = React.forwardRef<SVGSVGElement, SiCliqzProps>(function SiCliqz({title = 'Cliqz', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCliqz as default, defaultColor };
