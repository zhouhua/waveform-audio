    ...
    type SiSkyrockProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSkyrock: IconType = React.forwardRef<SVGSVGElement, SiSkyrockProps>(function SiSkyrock({title = 'Skyrock', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
