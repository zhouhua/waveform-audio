    ...
    type SiRevueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRevue: IconType = React.forwardRef<SVGSVGElement, SiRevueProps>(function SiRevue({title = 'Revue', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRevue as default, defaultColor };
