    ...
    type SiTableauProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E97627';

    const SiTableau: IconType = React.forwardRef<SVGSVGElement, SiTableauProps>(function SiTableau({title = 'Tableau', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTableau as default, defaultColor };
