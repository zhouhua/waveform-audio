    ...
    type SiAmazonpayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonpay: IconType = React.forwardRef<SVGSVGElement, SiAmazonpayProps>(function SiAmazonpay({title = 'Amazon Pay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
