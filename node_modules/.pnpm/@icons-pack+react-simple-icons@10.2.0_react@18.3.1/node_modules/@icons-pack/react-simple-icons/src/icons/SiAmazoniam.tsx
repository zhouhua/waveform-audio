    ...
    type SiAmazoniamProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazoniam: IconType = React.forwardRef<SVGSVGElement, SiAmazoniamProps>(function SiAmazoniam({title = 'Amazon Identity Access Management', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
