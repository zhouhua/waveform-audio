    ...
    type SiAwsorganizationsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAwsorganizations: IconType = React.forwardRef<SVGSVGElement, SiAwsorganizationsProps>(function SiAwsorganizations({title = 'AWS Organizations', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAwsorganizations as default, defaultColor };
