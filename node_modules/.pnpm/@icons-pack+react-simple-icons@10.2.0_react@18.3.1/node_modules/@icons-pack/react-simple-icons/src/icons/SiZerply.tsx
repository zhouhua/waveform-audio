    ...
    type SiZerplyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZerply: IconType = React.forwardRef<SVGSVGElement, SiZerplyProps>(function SiZerply({title = 'Zerply', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
