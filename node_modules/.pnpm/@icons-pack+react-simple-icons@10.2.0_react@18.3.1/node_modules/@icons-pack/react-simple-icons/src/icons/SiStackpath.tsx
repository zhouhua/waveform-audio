    ...
    type SiStackpathProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStackpath: IconType = React.forwardRef<SVGSVGElement, SiStackpathProps>(function SiStackpath({title = 'StackPath', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStackpath as default, defaultColor };
