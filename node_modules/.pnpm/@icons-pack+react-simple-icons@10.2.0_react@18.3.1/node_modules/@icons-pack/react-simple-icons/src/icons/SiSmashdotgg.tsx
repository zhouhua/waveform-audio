    ...
    type SiSmashdotggProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSmashdotgg: IconType = React.forwardRef<SVGSVGElement, SiSmashdotggProps>(function SiSmashdotgg({title = 'smash.gg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
