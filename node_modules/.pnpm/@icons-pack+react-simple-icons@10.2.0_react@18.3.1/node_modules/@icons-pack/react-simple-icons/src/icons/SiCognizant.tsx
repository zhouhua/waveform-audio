    ...
    type SiCognizantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCognizant: IconType = React.forwardRef<SVGSVGElement, SiCognizantProps>(function SiCognizant({title = 'Cognizant', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCognizant as default, defaultColor };
