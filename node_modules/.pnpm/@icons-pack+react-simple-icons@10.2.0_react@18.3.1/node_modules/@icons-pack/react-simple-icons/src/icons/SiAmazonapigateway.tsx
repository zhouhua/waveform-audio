    ...
    type SiAmazonapigatewayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonapigateway: IconType = React.forwardRef<SVGSVGElement, SiAmazonapigatewayProps>(function SiAmazonapigateway({title = 'Amazon API Gateway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
