    ...
    type SiAltiumdesignerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAltiumdesigner: IconType = React.forwardRef<SVGSVGElement, SiAltiumdesignerProps>(function SiAltiumdesigner({title = 'Altium Designer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
