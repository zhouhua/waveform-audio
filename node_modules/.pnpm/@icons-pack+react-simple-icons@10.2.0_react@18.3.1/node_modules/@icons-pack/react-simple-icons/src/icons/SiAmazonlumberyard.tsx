    ...
    type SiAmazonlumberyardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#66459B';

    const SiAmazonlumberyard: IconType = React.forwardRef<SVGSVGElement, SiAmazonlumberyardProps>(function SiAmazonlumberyard({title = 'Amazon Lumberyard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
