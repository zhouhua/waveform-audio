    ...
    type SiCodeiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#09B6A2';

    const SiCodeium: IconType = React.forwardRef<SVGSVGElement, SiCodeiumProps>(function SiCodeium({title = 'Codeium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
