    ...
    type SiCaffeineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaffeine: IconType = React.forwardRef<SVGSVGElement, SiCaffeineProps>(function SiCaffeine({title = 'Caffeine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
