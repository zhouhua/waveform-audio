    ...
    type SiPixivProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPixiv: IconType = React.forwardRef<SVGSVGElement, SiPixivProps>(function SiPixiv({title = 'pixiv', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
