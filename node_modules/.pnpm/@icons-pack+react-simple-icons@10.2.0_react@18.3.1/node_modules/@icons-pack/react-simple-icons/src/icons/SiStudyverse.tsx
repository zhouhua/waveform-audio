    ...
    type SiStudyverseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStudyverse: IconType = React.forwardRef<SVGSVGElement, SiStudyverseProps>(function SiStudyverse({title = 'Studyverse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStudyverse as default, defaultColor };
