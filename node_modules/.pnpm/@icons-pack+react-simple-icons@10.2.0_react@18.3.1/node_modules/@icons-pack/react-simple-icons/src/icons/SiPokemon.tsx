    ...
    type SiPokemonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFCB05';

    const SiPokemon: IconType = React.forwardRef<SVGSVGElement, SiPokemonProps>(function SiPokemon({title = 'Pokémon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPokemon as default, defaultColor };
