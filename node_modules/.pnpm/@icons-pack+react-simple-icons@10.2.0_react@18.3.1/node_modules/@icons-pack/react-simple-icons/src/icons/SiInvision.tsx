    ...
    type SiInvisionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInvision: IconType = React.forwardRef<SVGSVGElement, SiInvisionProps>(function SiInvision({title = 'InVision', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInvision as default, defaultColor };
