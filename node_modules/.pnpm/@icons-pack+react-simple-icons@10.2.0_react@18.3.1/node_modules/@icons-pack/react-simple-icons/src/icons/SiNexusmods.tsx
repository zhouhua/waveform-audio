    ...
    type SiNexusmodsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E6832B';

    const SiNexusmods: IconType = React.forwardRef<SVGSVGElement, SiNexusmodsProps>(function SiNexusmods({title = 'Nexus Mods', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNexusmods as default, defaultColor };
