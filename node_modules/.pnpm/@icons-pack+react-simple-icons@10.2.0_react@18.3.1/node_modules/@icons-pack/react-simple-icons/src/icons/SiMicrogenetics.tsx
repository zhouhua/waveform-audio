    ...
    type SiMicrogeneticsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrogenetics: IconType = React.forwardRef<SVGSVGElement, SiMicrogeneticsProps>(function SiMicrogenetics({title = 'Microgenetics', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrogenetics as default, defaultColor };
