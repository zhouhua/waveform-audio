    ...
    type SiGameandwatchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGameandwatch: IconType = React.forwardRef<SVGSVGElement, SiGameandwatchProps>(function SiGameandwatch({title = 'Game & Watch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGameandwatch as default, defaultColor };
