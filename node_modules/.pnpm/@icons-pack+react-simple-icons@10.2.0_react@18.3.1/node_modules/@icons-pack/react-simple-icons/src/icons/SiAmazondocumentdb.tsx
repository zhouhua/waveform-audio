    ...
    type SiAmazondocumentdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazondocumentdb: IconType = React.forwardRef<SVGSVGElement, SiAmazondocumentdbProps>(function SiAmazondocumentdb({title = 'Amazon DocumentDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
