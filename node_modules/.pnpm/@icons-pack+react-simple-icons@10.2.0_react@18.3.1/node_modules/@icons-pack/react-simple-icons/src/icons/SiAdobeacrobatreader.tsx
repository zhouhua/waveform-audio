    ...
    type SiAdobeacrobatreaderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobeacrobatreader: IconType = React.forwardRef<SVGSVGElement, SiAdobeacrobatreaderProps>(function SiAdobeacrobatreader({title = 'Adobe Acrobat Reader', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
