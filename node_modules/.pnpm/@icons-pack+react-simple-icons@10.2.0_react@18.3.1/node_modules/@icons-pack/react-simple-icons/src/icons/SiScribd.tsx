    ...
    type SiScribdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScribd: IconType = React.forwardRef<SVGSVGElement, SiScribdProps>(function SiScribd({title = 'Scribd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScribd as default, defaultColor };
