    ...
    type SiAerlingusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAerlingus: IconType = React.forwardRef<SVGSVGElement, SiAerlingusProps>(function SiAerlingus({title = 'Aer Lingus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAerlingus as default, defaultColor };
