    ...
    type SiWarnerbrosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#004DB4';

    const SiWarnerbros: IconType = React.forwardRef<SVGSVGElement, SiWarnerbrosProps>(function SiWarnerbros({title = 'Warner Bros.', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
