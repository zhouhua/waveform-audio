    ...
    type SiCoilProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoil: IconType = React.forwardRef<SVGSVGElement, SiCoilProps>(function SiCoil({title = 'Coil', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
