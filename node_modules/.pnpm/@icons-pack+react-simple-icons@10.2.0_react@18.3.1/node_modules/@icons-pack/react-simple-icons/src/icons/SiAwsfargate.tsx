    ...
    type SiAwsfargateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAwsfargate: IconType = React.forwardRef<SVGSVGElement, SiAwsfargateProps>(function SiAwsfargate({title = 'AWS Fargate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAwsfargate as default, defaultColor };
