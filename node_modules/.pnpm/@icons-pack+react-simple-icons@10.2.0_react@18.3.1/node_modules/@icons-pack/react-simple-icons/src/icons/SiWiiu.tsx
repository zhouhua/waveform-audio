    ...
    type SiWiiuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWiiu: IconType = React.forwardRef<SVGSVGElement, SiWiiuProps>(function SiWiiu({title = 'Wii U', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWiiu as default, defaultColor };
