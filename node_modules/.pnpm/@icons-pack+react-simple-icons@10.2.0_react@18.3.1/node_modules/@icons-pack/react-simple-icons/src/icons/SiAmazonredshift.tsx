    ...
    type SiAmazonredshiftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonredshift: IconType = React.forwardRef<SVGSVGElement, SiAmazonredshiftProps>(function SiAmazonredshift({title = 'Amazon Redshift', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonredshift as default, defaultColor };
