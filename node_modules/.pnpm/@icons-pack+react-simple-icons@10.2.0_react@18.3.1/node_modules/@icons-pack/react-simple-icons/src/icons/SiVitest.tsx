    ...
    type SiVitestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6E9F18';

    const SiVitest: IconType = React.forwardRef<SVGSVGElement, SiVitestProps>(function SiVitest({title = 'Vitest', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
