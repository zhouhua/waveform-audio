    ...
    type SiNintendogamecubeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6A5FBB';

    const SiNintendogamecube: IconType = React.forwardRef<SVGSVGElement, SiNintendogamecubeProps>(function SiNintendogamecube({title = 'Nintendo GameCube', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNintendogamecube as default, defaultColor };
