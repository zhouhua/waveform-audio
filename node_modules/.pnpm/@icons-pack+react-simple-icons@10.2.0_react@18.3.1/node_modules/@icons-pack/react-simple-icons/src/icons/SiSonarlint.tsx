    ...
    type SiSonarlintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonarlint: IconType = React.forwardRef<SVGSVGElement, SiSonarlintProps>(function SiSonarlint({title = 'SonarLint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
