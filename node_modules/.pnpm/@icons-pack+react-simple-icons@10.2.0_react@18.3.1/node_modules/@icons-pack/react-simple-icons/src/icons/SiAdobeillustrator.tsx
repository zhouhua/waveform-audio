    ...
    type SiAdobeillustratorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobeillustrator: IconType = React.forwardRef<SVGSVGElement, SiAdobeillustratorProps>(function SiAdobeillustrator({title = 'Adobe Illustrator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
