...
const defaultColor = "#891B26";
const SiAffinitypublisher = React__namespace.forwardRef(function SiAffinitypublisher2({ title = "Affinity Publisher", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
