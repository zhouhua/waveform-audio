...
const defaultColor = "#D12228";
const SiNintendo3ds = React.forwardRef(function SiNintendo3ds2({ title = "Nintendo 3DS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
