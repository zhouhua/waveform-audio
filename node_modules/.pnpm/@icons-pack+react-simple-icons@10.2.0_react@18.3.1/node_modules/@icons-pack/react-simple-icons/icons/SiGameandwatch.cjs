...
const SiGameandwatch = React__namespace.forwardRef(function SiGameandwatch2({ title = "Game & Watch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
