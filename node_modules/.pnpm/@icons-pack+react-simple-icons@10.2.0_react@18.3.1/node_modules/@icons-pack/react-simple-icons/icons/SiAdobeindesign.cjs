...
const SiAdobeindesign = React__namespace.forwardRef(function SiAdobeindesign2({ title = "Adobe InDesign", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
