...
const defaultColor = "#D94F00";
const SiOpnsense = React.forwardRef(function SiOpnsense2({ title = "OPNSense", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiOpnsense as default, defaultColor };
