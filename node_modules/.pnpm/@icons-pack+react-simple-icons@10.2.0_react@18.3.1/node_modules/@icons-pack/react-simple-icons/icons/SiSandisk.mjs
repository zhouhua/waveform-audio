...
const SiSandisk = React.forwardRef(function SiSandisk2({ title = "SanDisk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
