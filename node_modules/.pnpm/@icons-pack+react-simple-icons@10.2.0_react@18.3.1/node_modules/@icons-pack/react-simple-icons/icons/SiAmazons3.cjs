...
const defaultColor = "#569A31";
const SiAmazons3 = React__namespace.forwardRef(function SiAmazons32({ title = "Amazon S3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
