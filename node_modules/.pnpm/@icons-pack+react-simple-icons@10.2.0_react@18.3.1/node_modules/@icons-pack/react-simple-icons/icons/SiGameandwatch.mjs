...
const SiGameandwatch = React.forwardRef(function SiGameandwatch2({ title = "Game & Watch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
