...
const SiPixiv = React.forwardRef(function SiPixiv2({ title = "pixiv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
