...
const SiTableau = React.forwardRef(function SiTableau2({ title = "Tableau", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
