...
const SiAmazoneks = React.forwardRef(function SiAmazoneks2({ title = "Amazon EKS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
