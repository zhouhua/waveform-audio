...
const defaultColor = "#FECC00";
const SiAllocine = React__namespace.forwardRef(function SiAllocine2({ title = "AlloCiné", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
