...
const SiAdobecreativecloud = React.forwardRef(function SiAdobecreativecloud2({ title = "Adobe Creative Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
