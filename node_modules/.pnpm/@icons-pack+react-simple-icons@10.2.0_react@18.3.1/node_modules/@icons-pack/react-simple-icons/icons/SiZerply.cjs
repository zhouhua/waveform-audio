...
const defaultColor = "#7BBB6E";
const SiZerply = React__namespace.forwardRef(function SiZerply2({ title = "Zerply", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
