...
const defaultColor = "#E7157B";
const SiAwsorganizations = React__namespace.forwardRef(function SiAwsorganizations2({ title = "AWS Organizations", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
