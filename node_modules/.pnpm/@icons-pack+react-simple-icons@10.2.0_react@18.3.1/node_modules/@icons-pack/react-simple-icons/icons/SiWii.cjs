...
const SiWii = React__namespace.forwardRef(function SiWii2({ title = "Wii", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
