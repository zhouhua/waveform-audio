...
const SiAmazons3 = React.forwardRef(function SiAmazons32({ title = "Amazon S3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
