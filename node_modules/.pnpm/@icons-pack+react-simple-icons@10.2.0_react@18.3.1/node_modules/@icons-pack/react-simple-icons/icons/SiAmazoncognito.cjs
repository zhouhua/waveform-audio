...
const SiAmazoncognito = React__namespace.forwardRef(function SiAmazoncognito2({ title = "Amazon Cognito", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
