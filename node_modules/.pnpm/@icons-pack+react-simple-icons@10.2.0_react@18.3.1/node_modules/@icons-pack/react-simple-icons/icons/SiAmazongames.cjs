...
const SiAmazongames = React__namespace.forwardRef(function SiAmazongames2({ title = "Amazon Games", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
