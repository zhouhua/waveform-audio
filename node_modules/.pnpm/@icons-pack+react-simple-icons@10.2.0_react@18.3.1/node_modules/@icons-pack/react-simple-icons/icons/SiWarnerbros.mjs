...
const SiWarnerbros = React.forwardRef(function SiWarnerbros2({ title = "Warner Bros.", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
