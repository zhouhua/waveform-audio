...
const SiTutanota = React.forwardRef(function SiTutanota2({ title = "Tutanota", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
