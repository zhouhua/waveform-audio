...
const SiActigraph = React.forwardRef(function SiActigraph2({ title = "ActiGraph", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
