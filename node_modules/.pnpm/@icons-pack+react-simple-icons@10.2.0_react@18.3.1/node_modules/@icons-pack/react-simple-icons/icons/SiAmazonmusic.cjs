...
const defaultColor = "#46C3D0";
const SiAmazonmusic = React__namespace.forwardRef(function SiAmazonmusic2({ title = "Amazon Music", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
