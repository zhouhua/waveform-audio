...
const SiUptobox = React.forwardRef(function SiUptobox2({ title = "Uptobox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
