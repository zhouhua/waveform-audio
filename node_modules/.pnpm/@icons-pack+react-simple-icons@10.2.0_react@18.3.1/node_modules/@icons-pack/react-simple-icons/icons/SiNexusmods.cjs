...
const SiNexusmods = React__namespace.forwardRef(function SiNexusmods2({ title = "Nexus Mods", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
