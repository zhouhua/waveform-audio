...
const SiMusescore = React.forwardRef(function SiMusescore2({ title = "MuseScore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
