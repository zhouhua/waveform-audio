...
const defaultColor = "#005A2B";
const SiLandrover = React__namespace.forwardRef(function SiLandrover2({ title = "Land Rover", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
