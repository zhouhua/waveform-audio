...
const SiMicrogenetics = React__namespace.forwardRef(function SiMicrogenetics2({ title = "Microgenetics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
