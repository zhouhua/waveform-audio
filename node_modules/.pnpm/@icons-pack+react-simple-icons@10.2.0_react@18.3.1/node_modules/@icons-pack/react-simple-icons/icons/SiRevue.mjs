...
const SiRevue = React.forwardRef(function SiRevue2({ title = "Revue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
