...
const SiAmazonelasticache = React.forwardRef(function SiAmazonelasticache2({ title = "Amazon ElastiCache", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
