...
const SiJaguar = React.forwardRef(function SiJaguar2({ title = "Jaguar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
