...
const SiSmashdotgg = React__namespace.forwardRef(function SiSmashdotgg2({ title = "smash.gg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
