...
const defaultColor = "#CB2029";
const SiSonarlint = React__namespace.forwardRef(function SiSonarlint2({ title = "SonarLint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
