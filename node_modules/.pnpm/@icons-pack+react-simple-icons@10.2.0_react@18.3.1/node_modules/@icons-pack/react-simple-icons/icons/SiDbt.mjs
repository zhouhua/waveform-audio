...
const SiDbt = React.forwardRef(function SiDbt2({ title = "dbt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
