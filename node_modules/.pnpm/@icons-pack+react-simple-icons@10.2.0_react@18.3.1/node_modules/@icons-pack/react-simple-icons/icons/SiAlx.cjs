...
const defaultColor = "#002B56";
const SiAlx = React__namespace.forwardRef(function SiAlx2({ title = "ALX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
