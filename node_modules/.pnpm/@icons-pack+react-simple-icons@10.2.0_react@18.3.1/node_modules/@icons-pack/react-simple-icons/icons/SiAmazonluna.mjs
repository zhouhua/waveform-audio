...
const SiAmazonluna = React.forwardRef(function SiAmazonluna2({ title = "Amazon Luna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
