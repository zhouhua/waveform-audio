...
const SiAwsfargate = React__namespace.forwardRef(function SiAwsfargate2({ title = "AWS Fargate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
