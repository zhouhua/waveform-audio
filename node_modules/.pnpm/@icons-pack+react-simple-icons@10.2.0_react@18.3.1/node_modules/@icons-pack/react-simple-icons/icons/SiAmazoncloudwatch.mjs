...
const SiAmazoncloudwatch = React.forwardRef(function SiAmazoncloudwatch2({ title = "Amazon CloudWatch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
