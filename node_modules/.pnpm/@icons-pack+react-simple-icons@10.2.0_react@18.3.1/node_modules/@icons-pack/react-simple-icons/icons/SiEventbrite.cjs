...
const SiEventbrite = React__namespace.forwardRef(function SiEventbrite2({ title = "Eventbrite", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
