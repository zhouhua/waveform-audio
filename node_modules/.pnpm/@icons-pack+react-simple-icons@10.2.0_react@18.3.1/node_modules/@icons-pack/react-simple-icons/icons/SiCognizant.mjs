...
const SiCognizant = React.forwardRef(function SiCognizant2({ title = "Cognizant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
