...
const SiAwslambda = React.forwardRef(function SiAwslambda2({ title = "AWS Lambda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
