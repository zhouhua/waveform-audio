...
const SiAmazonrds = React.forwardRef(function SiAmazonrds2({ title = "Amazon RDS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
