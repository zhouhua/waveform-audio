...
const defaultColor = "#1A4CA1";
const SiCognizant = React__namespace.forwardRef(function SiCognizant2({ title = "Cognizant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
