...
const SiSkyrock = React.forwardRef(function SiSkyrock2({ title = "Skyrock", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
