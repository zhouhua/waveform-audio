...
const SiScribd = React.forwardRef(function SiScribd2({ title = "Scribd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
