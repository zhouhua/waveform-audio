...
const SiTunein = React__namespace.forwardRef(function SiTunein2({ title = "TuneIn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
