...
const defaultColor = "#39477F";
const SiRealm = React__namespace.forwardRef(function SiRealm2({ title = "Realm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
