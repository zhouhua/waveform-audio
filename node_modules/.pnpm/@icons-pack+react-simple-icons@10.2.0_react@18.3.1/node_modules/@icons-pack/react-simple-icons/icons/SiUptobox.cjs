...
const defaultColor = "#5CE1E6";
const SiUptobox = React__namespace.forwardRef(function SiUptobox2({ title = "Uptobox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
