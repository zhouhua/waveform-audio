...
const defaultColor = "#183A61";
const SiVirtualbox = React__namespace.forwardRef(function SiVirtualbox2({ title = "VirtualBox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
