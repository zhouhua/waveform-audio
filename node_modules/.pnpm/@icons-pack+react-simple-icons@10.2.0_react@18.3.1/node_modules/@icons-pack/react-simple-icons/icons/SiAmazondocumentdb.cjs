...
const defaultColor = "#C925D1";
const SiAmazondocumentdb = React__namespace.forwardRef(function SiAmazondocumentdb2({ title = "Amazon DocumentDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
