...
const SiAmazoneks = React__namespace.forwardRef(function SiAmazoneks2({ title = "Amazon EKS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
