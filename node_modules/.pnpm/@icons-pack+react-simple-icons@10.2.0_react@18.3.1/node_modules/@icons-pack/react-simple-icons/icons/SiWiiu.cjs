...
const SiWiiu = React__namespace.forwardRef(function SiWiiu2({ title = "Wii U", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
