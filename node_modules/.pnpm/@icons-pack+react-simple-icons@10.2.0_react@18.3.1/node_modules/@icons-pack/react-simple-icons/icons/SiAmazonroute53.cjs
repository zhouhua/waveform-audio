...
const SiAmazonroute53 = React__namespace.forwardRef(function SiAmazonroute532({ title = "Amazon Route 53", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
