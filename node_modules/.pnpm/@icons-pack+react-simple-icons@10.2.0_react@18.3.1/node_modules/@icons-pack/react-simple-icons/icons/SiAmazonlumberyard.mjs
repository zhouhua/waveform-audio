...
const SiAmazonlumberyard = React.forwardRef(function SiAmazonlumberyard2({ title = "Amazon Lumberyard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
