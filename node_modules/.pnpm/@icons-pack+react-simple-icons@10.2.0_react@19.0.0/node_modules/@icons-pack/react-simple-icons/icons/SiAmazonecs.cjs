...
const SiAmazonecs = React__namespace.forwardRef(function SiAmazonecs2({ title = "Amazon ECS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
