...
const SiNintendo = React__namespace.forwardRef(function SiNintendo2({ title = "Nintendo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
