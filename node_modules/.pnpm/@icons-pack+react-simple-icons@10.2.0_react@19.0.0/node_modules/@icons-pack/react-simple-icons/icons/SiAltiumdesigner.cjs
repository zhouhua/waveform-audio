...
const defaultColor = "#A5915F";
const SiAltiumdesigner = React__namespace.forwardRef(function SiAltiumdesigner2({ title = "Altium Designer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
