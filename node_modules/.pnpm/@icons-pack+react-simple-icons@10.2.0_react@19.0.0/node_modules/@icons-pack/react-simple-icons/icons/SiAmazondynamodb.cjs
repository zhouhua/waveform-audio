...
const SiAmazondynamodb = React__namespace.forwardRef(function SiAmazondynamodb2({ title = "Amazon DynamoDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
