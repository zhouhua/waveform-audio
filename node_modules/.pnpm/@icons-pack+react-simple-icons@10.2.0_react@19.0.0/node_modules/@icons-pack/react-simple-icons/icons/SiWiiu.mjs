...
const SiWiiu = React.forwardRef(function SiWiiu2({ title = "Wii U", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
