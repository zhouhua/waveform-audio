...
const SiAmazoniam = React__namespace.forwardRef(function SiAmazoniam2({ title = "Amazon Identity Access Management", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
