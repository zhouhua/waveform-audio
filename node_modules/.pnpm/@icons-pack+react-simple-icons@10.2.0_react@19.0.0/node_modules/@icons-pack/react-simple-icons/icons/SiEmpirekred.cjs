...
const SiEmpirekred = React__namespace.forwardRef(function SiEmpirekred2({ title = "Empire Kred", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
