...
const SiAmazonapigateway = React.forwardRef(function SiAmazonapigateway2({ title = "Amazon API Gateway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
