...
const SiAew = React__namespace.forwardRef(function SiAew2({ title = "AEW", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
