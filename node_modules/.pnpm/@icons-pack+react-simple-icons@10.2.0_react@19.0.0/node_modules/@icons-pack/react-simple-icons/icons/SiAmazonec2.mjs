...
const SiAmazonec2 = React.forwardRef(function SiAmazonec22({ title = "Amazon EC2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
