...
const defaultColor = "#F48220";
const SiKatacoda = React.forwardRef(function SiKatacoda2({ title = "Katacoda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
