...
const SiVitest = React__namespace.forwardRef(function SiVitest2({ title = "Vitest", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
