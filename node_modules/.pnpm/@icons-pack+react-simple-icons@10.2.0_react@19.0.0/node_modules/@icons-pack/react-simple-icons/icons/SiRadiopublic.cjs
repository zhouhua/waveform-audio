...
const SiRadiopublic = React__namespace.forwardRef(function SiRadiopublic2({ title = "RadioPublic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
