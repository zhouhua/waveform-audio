...
const defaultColor = "#1E7B85";
const SiScribd = React__namespace.forwardRef(function SiScribd2({ title = "Scribd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
