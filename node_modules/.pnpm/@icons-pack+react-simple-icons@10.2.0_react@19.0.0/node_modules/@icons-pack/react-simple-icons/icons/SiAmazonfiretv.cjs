...
const SiAmazonfiretv = React__namespace.forwardRef(function SiAmazonfiretv2({ title = "Amazon Fire TV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
