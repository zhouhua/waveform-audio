...
const defaultColor = "#DD344C";
const SiAmazoniam = React.forwardRef(function SiAmazoniam2({ title = "Amazon Identity Access Management", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
