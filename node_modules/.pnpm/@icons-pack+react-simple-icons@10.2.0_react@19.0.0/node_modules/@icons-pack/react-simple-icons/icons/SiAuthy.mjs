...
const SiAuthy = React.forwardRef(function SiAuthy2({ title = "Authy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
