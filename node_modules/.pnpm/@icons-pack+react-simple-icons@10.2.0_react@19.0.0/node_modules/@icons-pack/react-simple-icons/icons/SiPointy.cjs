...
const SiPointy = React__namespace.forwardRef(function SiPointy2({ title = "Pointy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
