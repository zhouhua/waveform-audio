...
const SiZerply = React.forwardRef(function SiZerply2({ title = "Zerply", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
