...
const defaultColor = "#DD1F26";
const SiGeant = React__namespace.forwardRef(function SiGeant2({ title = "Géant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
