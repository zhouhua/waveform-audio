...
const defaultColor = "#E15718";
const SiRevue = React__namespace.forwardRef(function SiRevue2({ title = "Revue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
