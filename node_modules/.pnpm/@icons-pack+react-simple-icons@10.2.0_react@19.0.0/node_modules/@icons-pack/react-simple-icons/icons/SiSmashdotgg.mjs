...
const defaultColor = "#CB333B";
const SiSmashdotgg = React.forwardRef(function SiSmashdotgg2({ title = "smash.gg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
