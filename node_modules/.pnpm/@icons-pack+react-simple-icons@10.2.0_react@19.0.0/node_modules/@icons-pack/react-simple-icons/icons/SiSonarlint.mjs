...
const SiSonarlint = React.forwardRef(function SiSonarlint2({ title = "SonarLint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
