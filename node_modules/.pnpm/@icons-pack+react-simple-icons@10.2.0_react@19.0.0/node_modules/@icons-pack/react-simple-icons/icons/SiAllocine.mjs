...
const SiAllocine = React.forwardRef(function SiAllocine2({ title = "AlloCiné", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
