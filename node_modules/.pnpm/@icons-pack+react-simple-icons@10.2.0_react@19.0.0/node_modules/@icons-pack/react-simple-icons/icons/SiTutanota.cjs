...
const defaultColor = "#840010";
const SiTutanota = React__namespace.forwardRef(function SiTutanota2({ title = "Tutanota", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
