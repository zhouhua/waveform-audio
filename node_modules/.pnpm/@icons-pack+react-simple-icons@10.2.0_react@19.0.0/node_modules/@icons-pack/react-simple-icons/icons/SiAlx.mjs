...
const SiAlx = React.forwardRef(function SiAlx2({ title = "ALX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
