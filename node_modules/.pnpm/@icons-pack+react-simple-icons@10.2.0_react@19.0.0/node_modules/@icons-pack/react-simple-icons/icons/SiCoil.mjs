...
const SiCoil = React.forwardRef(function SiCoil2({ title = "Coil", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
