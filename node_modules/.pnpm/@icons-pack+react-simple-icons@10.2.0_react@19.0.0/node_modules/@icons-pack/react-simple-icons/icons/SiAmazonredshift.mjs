...
const SiAmazonredshift = React.forwardRef(function SiAmazonredshift2({ title = "Amazon Redshift", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
