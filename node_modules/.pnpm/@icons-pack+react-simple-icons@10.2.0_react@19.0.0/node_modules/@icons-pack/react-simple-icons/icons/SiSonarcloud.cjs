...
const SiSonarcloud = React__namespace.forwardRef(function SiSonarcloud2({ title = "SonarCloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
