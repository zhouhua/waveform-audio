...
const SiWarnerbros = React__namespace.forwardRef(function SiWarnerbros2({ title = "Warner Bros.", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
