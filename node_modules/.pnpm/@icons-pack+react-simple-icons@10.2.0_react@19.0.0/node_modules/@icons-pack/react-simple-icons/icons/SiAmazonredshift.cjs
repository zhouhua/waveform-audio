...
const defaultColor = "#8C4FFF";
const SiAmazonredshift = React__namespace.forwardRef(function SiAmazonredshift2({ title = "Amazon Redshift", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
