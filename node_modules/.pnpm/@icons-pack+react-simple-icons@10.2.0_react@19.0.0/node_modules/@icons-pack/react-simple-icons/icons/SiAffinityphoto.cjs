...
const defaultColor = "#4E3188";
const SiAffinityphoto = React__namespace.forwardRef(function SiAffinityphoto2({ title = "Affinity Photo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiAffinityphoto;
