...
const defaultColor = "#1D29E4";
const SiStudyverse = React__namespace.forwardRef(function SiStudyverse2({ title = "Studyverse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
