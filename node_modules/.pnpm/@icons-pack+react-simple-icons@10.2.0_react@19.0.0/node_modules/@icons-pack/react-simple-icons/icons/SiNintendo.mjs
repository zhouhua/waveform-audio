...
const SiNintendo = React.forwardRef(function SiNintendo2({ title = "Nintendo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
