...
const SiGooglefit = React.forwardRef(function SiGooglefit2({ title = "Google Fit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
