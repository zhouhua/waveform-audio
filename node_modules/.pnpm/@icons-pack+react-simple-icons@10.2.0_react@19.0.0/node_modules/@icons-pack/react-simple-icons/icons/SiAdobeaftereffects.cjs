...
const SiAdobeaftereffects = React__namespace.forwardRef(function SiAdobeaftereffects2({ title = "Adobe After Effects", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
