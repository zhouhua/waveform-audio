...
const SiAerlingus = React.forwardRef(function SiAerlingus2({ title = "Aer Lingus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
