...
const SiInvision = React__namespace.forwardRef(function SiInvision2({ title = "InVision", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
