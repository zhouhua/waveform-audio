...
const SiEljueves = React.forwardRef(function SiEljueves2({ title = "El Jueves", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
