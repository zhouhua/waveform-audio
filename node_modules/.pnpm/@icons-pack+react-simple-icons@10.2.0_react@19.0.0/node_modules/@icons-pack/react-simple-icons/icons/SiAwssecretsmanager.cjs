...
const SiAwssecretsmanager = React__namespace.forwardRef(function SiAwssecretsmanager2({ title = "AWS Secrets Manager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
