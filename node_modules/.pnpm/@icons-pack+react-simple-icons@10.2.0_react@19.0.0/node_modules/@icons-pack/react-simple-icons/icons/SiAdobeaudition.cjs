...
const defaultColor = "#9999FF";
const SiAdobeaudition = React__namespace.forwardRef(function SiAdobeaudition2({ title = "Adobe Audition", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiAdobeaudition;
