...
const SiWalmart = React__namespace.forwardRef(function SiWalmart2({ title = "Walmart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
