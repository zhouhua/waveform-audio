...
const SiGoogledatastudio = React__namespace.forwardRef(function SiGoogledatastudio2({ title = "Google Data Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
