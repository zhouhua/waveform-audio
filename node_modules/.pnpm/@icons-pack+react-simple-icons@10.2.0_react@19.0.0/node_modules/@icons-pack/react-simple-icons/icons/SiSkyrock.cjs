...
const SiSkyrock = React__namespace.forwardRef(function SiSkyrock2({ title = "Skyrock", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
