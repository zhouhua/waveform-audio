...
const SiAmazonsimpleemailservice = React__namespace.forwardRef(function SiAmazonsimpleemailservice2({ title = "Amazon Simple Email Service", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
