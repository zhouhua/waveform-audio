...
const SiPokemon = React__namespace.forwardRef(function SiPokemon2({ title = "Pokémon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
