...
const SiCodeium = React.forwardRef(function SiCodeium2({ title = "Codeium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
