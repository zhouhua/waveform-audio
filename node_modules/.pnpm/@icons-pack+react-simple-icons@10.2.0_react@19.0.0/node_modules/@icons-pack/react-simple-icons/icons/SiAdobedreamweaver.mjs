...
const SiAdobedreamweaver = React.forwardRef(function SiAdobedreamweaver2({ title = "Adobe Dreamweaver", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
