...
const SiMinetest = React__namespace.forwardRef(function SiMinetest2({ title = "Minetest", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
