...
const SiGrubhub = React.forwardRef(function SiGrubhub2({ title = "Grubhub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
