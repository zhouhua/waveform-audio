...
const SiInvision = React.forwardRef(function SiInvision2({ title = "InVision", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
