...
const defaultColor = "#134881";
const SiAffinitydesigner = React__namespace.forwardRef(function SiAffinitydesigner2({ title = "Affinity Designer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiAffinitydesigner;
