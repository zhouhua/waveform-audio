...
const SiAwsorganizations = React.forwardRef(function SiAwsorganizations2({ title = "AWS Organizations", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
