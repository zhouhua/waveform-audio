...
const SiAdobepremierepro = React__namespace.forwardRef(function SiAdobepremierepro2({ title = "Adobe Premiere Pro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
