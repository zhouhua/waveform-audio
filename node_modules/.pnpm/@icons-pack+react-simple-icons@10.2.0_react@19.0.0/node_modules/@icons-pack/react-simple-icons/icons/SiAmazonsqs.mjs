...
const SiAmazonsqs = React.forwardRef(function SiAmazonsqs2({ title = "Amazon SQS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
