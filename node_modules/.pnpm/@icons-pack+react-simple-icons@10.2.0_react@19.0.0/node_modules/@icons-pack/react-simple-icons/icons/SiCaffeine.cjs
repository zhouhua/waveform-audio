...
const SiCaffeine = React__namespace.forwardRef(function SiCaffeine2({ title = "Caffeine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
