...
const SiNintendo3ds = React__namespace.forwardRef(function SiNintendo3ds2({ title = "Nintendo 3DS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
