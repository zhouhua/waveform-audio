...
const SiAltiumdesigner = React.forwardRef(function SiAltiumdesigner2({ title = "Altium Designer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
