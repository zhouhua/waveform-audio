...
const SiCoil = React__namespace.forwardRef(function SiCoil2({ title = "Coil", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
