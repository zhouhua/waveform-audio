...
const SiAmazonpay = React.forwardRef(function SiAmazonpay2({ title = "Amazon Pay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
