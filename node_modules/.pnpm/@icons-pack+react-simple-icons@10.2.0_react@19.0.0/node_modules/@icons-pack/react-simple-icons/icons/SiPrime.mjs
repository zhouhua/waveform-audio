...
const SiPrime = React.forwardRef(function SiPrime2({ title = "Prime", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
