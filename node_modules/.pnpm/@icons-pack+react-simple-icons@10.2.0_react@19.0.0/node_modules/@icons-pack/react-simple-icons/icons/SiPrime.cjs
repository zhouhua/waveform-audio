...
const defaultColor = "#00A8E1";
const SiPrime = React__namespace.forwardRef(function SiPrime2({ title = "Prime", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
