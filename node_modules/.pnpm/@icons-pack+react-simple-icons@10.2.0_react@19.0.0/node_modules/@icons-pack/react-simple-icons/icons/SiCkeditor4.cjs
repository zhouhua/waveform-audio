...
const SiCkeditor4 = React__namespace.forwardRef(function SiCkeditor42({ title = "CKEditor 4", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
