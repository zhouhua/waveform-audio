...
const defaultColor = "#F63440";
const SiGrubhub = React__namespace.forwardRef(function SiGrubhub2({ title = "Grubhub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
