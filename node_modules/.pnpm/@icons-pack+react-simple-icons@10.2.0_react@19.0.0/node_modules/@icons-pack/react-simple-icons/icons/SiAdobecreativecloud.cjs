...
const defaultColor = "#DA1F26";
const SiAdobecreativecloud = React__namespace.forwardRef(function SiAdobecreativecloud2({ title = "Adobe Creative Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
