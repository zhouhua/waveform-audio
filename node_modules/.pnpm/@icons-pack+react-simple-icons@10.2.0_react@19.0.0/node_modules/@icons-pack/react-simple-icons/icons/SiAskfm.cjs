...
const SiAskfm = React__namespace.forwardRef(function SiAskfm2({ title = "ASKfm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
