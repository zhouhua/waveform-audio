...
const SiAdobelightroomclassic = React__namespace.forwardRef(function SiAdobelightroomclassic2({ title = "Adobe Lightroom Classic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiAdobelightroomclassic;
