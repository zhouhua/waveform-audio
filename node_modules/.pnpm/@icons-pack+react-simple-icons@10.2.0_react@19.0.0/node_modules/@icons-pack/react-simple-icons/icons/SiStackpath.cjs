...
const SiStackpath = React__namespace.forwardRef(function SiStackpath2({ title = "StackPath", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
