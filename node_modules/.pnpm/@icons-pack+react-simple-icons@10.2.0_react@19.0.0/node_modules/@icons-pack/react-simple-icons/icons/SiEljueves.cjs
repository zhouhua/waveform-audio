...
const defaultColor = "#BE312E";
const SiEljueves = React__namespace.forwardRef(function SiEljueves2({ title = "El Jueves", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
