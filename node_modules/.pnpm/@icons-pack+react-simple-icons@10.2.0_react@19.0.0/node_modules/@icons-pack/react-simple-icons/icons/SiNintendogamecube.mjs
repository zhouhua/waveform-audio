...
const SiNintendogamecube = React.forwardRef(function SiNintendogamecube2({ title = "Nintendo GameCube", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
