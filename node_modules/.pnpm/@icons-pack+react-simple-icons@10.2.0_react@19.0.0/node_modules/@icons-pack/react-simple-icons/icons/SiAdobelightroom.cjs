...
const SiAdobelightroom = React__namespace.forwardRef(function SiAdobelightroom2({ title = "Adobe Lightroom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
