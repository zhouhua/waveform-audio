    ...
    type SiPointyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009DE0';

    const SiPointy: IconType = React.forwardRef<SVGSVGElement, SiPointyProps>(function SiPointy({title = 'Pointy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPointy as default, defaultColor };
