    ...
    type SiTmobileProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTmobile: IconType = React.forwardRef<SVGSVGElement, SiTmobileProps>(function SiTmobile({title = 'T-Mobile', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTmobile as default, defaultColor };
