    ...
    type SiSonarcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F3702A';

    const SiSonarcloud: IconType = React.forwardRef<SVGSVGElement, SiSonarcloudProps>(function SiSonarcloud({title = 'SonarCloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonarcloud as default, defaultColor };
