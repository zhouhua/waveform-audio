    ...
    type SiAolProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAol: IconType = React.forwardRef<SVGSVGElement, SiAolProps>(function SiAol({title = 'AOL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAol as default, defaultColor };
