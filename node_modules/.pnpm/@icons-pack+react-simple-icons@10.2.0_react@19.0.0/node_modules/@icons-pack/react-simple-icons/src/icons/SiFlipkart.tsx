    ...
    type SiFlipkartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFlipkart: IconType = React.forwardRef<SVGSVGElement, SiFlipkartProps>(function SiFlipkart({title = 'Flipkart', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
