    ...
    type SiAdobeaftereffectsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobeaftereffects: IconType = React.forwardRef<SVGSVGElement, SiAdobeaftereffectsProps>(function SiAdobeaftereffects({title = 'Adobe After Effects', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
