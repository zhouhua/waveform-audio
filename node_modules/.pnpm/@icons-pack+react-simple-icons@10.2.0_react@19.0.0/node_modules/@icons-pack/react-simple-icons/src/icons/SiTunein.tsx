    ...
    type SiTuneinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#14D8CC';

    const SiTunein: IconType = React.forwardRef<SVGSVGElement, SiTuneinProps>(function SiTunein({title = 'TuneIn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTunein as default, defaultColor };
