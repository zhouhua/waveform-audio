    ...
    type SiAdobecreativecloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobecreativecloud: IconType = React.forwardRef<SVGSVGElement, SiAdobecreativecloudProps>(function SiAdobecreativecloud({title = 'Adobe Creative Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
