    ...
    type SiAmazonmusicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonmusic: IconType = React.forwardRef<SVGSVGElement, SiAmazonmusicProps>(function SiAmazonmusic({title = 'Amazon Music', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonmusic as default, defaultColor };
