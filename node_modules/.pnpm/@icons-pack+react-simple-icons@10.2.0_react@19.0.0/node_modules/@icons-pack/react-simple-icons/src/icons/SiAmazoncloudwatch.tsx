    ...
    type SiAmazoncloudwatchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazoncloudwatch: IconType = React.forwardRef<SVGSVGElement, SiAmazoncloudwatchProps>(function SiAmazoncloudwatch({title = 'Amazon CloudWatch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazoncloudwatch as default, defaultColor };
