    ...
    type SiUptoboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUptobox: IconType = React.forwardRef<SVGSVGElement, SiUptoboxProps>(function SiUptobox({title = 'Uptobox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
