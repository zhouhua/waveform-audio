    ...
    type SiAlfaromeoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#981E32';

    const SiAlfaromeo: IconType = React.forwardRef<SVGSVGElement, SiAlfaromeoProps>(function SiAlfaromeo({title = 'Alfa Romeo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlfaromeo as default, defaultColor };
