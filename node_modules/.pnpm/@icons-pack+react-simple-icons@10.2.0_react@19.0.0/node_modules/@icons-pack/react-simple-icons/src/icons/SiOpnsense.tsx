    ...
    type SiOpnsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpnsense: IconType = React.forwardRef<SVGSVGElement, SiOpnsenseProps>(function SiOpnsense({title = 'OPNSense', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
