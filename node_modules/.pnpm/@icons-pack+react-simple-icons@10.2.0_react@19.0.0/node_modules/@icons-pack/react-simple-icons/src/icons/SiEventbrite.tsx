    ...
    type SiEventbriteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEventbrite: IconType = React.forwardRef<SVGSVGElement, SiEventbriteProps>(function SiEventbrite({title = 'Eventbrite', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
