    ...
    type SiAewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAew: IconType = React.forwardRef<SVGSVGElement, SiAewProps>(function SiAew({title = 'AEW', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAew as default, defaultColor };
