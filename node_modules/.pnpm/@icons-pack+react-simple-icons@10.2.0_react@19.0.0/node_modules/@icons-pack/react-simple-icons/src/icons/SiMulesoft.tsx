    ...
    type SiMulesoftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A0DF';

    const SiMulesoft: IconType = React.forwardRef<SVGSVGElement, SiMulesoftProps>(function SiMulesoft({title = 'Mulesoft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMulesoft as default, defaultColor };
