    ...
    type SiRealmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRealm: IconType = React.forwardRef<SVGSVGElement, SiRealmProps>(function SiRealm({title = 'Realm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRealm as default, defaultColor };
