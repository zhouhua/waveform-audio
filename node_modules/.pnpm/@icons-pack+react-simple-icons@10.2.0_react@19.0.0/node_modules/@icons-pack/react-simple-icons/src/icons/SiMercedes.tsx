    ...
    type SiMercedesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMercedes: IconType = React.forwardRef<SVGSVGElement, SiMercedesProps>(function SiMercedes({title = 'Mercedes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
