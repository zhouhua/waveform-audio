    ...
    type SiGoogledatastudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledatastudio: IconType = React.forwardRef<SVGSVGElement, SiGoogledatastudioProps>(function SiGoogledatastudio({title = 'Google Data Studio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
