    ...
    type SiNextuiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNextui: IconType = React.forwardRef<SVGSVGElement, SiNextuiProps>(function SiNextui({title = 'NextUI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNextui as default, defaultColor };
