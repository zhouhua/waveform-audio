    ...
    type SiEljuevesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEljueves: IconType = React.forwardRef<SVGSVGElement, SiEljuevesProps>(function SiEljueves({title = 'El Jueves', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
