    ...
    type SiAmazondynamodbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4053D6';

    const SiAmazondynamodb: IconType = React.forwardRef<SVGSVGElement, SiAmazondynamodbProps>(function SiAmazondynamodb({title = 'Amazon DynamoDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazondynamodb as default, defaultColor };
