    ...
    type SiEmpirekredProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEmpirekred: IconType = React.forwardRef<SVGSVGElement, SiEmpirekredProps>(function SiEmpirekred({title = 'Empire Kred', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEmpirekred as default, defaultColor };
