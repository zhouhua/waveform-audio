    ...
    type SiSandiskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSandisk: IconType = React.forwardRef<SVGSVGElement, SiSandiskProps>(function SiSandisk({title = 'SanDisk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
