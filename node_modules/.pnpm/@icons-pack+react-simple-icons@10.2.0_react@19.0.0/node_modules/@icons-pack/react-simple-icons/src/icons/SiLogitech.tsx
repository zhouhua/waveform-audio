    ...
    type SiLogitechProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLogitech: IconType = React.forwardRef<SVGSVGElement, SiLogitechProps>(function SiLogitech({title = 'Logitech', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
