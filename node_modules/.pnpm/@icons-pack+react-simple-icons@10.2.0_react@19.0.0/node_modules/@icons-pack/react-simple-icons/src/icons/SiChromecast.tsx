    ...
    type SiChromecastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChromecast: IconType = React.forwardRef<SVGSVGElement, SiChromecastProps>(function SiChromecast({title = 'Chromecast', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChromecast as default, defaultColor };
