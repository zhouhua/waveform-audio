    ...
    type SiNintendo3dsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNintendo3ds: IconType = React.forwardRef<SVGSVGElement, SiNintendo3dsProps>(function SiNintendo3ds({title = 'Nintendo 3DS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
