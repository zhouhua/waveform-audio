    ...
    type SiAmazongamesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazongames: IconType = React.forwardRef<SVGSVGElement, SiAmazongamesProps>(function SiAmazongames({title = 'Amazon Games', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
