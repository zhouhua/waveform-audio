    ...
    type SiAdobefontsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobefonts: IconType = React.forwardRef<SVGSVGElement, SiAdobefontsProps>(function SiAdobefonts({title = 'Adobe Fonts', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
