    ...
    type SiAdobelightroomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobelightroom: IconType = React.forwardRef<SVGSVGElement, SiAdobelightroomProps>(function SiAdobelightroom({title = 'Adobe Lightroom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdobelightroom as default, defaultColor };
