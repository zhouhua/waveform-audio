    ...
    type SiAmazonlunaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonluna: IconType = React.forwardRef<SVGSVGElement, SiAmazonlunaProps>(function SiAmazonluna({title = 'Amazon Luna', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
