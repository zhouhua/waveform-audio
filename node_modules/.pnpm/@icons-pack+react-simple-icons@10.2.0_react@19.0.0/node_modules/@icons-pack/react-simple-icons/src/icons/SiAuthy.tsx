    ...
    type SiAuthyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAuthy: IconType = React.forwardRef<SVGSVGElement, SiAuthyProps>(function SiAuthy({title = 'Authy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
