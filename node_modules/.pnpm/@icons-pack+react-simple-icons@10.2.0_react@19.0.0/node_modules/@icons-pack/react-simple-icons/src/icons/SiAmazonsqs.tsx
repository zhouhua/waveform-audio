    ...
    type SiAmazonsqsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonsqs: IconType = React.forwardRef<SVGSVGElement, SiAmazonsqsProps>(function SiAmazonsqs({title = 'Amazon SQS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonsqs as default, defaultColor };
