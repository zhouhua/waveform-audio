    ...
    type SiAdobeindesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobeindesign: IconType = React.forwardRef<SVGSVGElement, SiAdobeindesignProps>(function SiAdobeindesign({title = 'Adobe InDesign', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
