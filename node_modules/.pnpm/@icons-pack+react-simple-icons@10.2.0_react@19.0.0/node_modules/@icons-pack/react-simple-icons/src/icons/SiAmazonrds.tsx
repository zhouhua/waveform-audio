    ...
    type SiAmazonrdsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonrds: IconType = React.forwardRef<SVGSVGElement, SiAmazonrdsProps>(function SiAmazonrds({title = 'Amazon RDS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonrds as default, defaultColor };
