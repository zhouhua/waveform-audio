    ...
    type SiAmazonelasticacheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonelasticache: IconType = React.forwardRef<SVGSVGElement, SiAmazonelasticacheProps>(function SiAmazonelasticache({title = 'Amazon ElastiCache', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonelasticache as default, defaultColor };
