    ...
    type SiAmazonec2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazonec2: IconType = React.forwardRef<SVGSVGElement, SiAmazonec2Props>(function SiAmazonec2({title = 'Amazon EC2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazonec2 as default, defaultColor };
