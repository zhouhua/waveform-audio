    ...
    type SiAdobedreamweaverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobedreamweaver: IconType = React.forwardRef<SVGSVGElement, SiAdobedreamweaverProps>(function SiAdobedreamweaver({title = 'Adobe Dreamweaver', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdobedreamweaver as default, defaultColor };
