    ...
    type SiCkeditor4Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCkeditor4: IconType = React.forwardRef<SVGSVGElement, SiCkeditor4Props>(function SiCkeditor4({title = 'CKEditor 4', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
