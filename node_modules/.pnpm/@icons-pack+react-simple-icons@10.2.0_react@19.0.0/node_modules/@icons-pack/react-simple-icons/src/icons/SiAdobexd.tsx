    ...
    type SiAdobexdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdobexd: IconType = React.forwardRef<SVGSVGElement, SiAdobexdProps>(function SiAdobexd({title = 'Adobe XD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
