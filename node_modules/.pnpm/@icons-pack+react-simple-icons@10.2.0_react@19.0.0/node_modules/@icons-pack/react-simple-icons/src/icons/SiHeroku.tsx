    ...
    type SiHerokuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHeroku: IconType = React.forwardRef<SVGSVGElement, SiHerokuProps>(function SiHeroku({title = 'Heroku', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
