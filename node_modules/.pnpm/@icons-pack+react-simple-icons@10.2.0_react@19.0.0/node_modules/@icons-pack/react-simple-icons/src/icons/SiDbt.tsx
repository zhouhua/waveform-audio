    ...
    type SiDbtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDbt: IconType = React.forwardRef<SVGSVGElement, SiDbtProps>(function SiDbt({title = 'dbt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
