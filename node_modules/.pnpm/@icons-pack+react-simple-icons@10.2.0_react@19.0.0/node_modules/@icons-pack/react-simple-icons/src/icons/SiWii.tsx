    ...
    type SiWiiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWii: IconType = React.forwardRef<SVGSVGElement, SiWiiProps>(function SiWii({title = 'Wii', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWii as default, defaultColor };
