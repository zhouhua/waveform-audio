    ...
    type SiAmazoneksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmazoneks: IconType = React.forwardRef<SVGSVGElement, SiAmazoneksProps>(function SiAmazoneks({title = 'Amazon EKS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmazoneks as default, defaultColor };
