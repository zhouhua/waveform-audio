    ...
    type SiRadiopublicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CE262F';

    const SiRadiopublic: IconType = React.forwardRef<SVGSVGElement, SiRadiopublicProps>(function SiRadiopublic({title = 'RadioPublic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRadiopublic as default, defaultColor };
