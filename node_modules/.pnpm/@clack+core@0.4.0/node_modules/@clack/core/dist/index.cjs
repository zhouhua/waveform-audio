...
`)),this._prevFrame=t;return}this.output.write(sisteransi.erase.down())}this.output.write(t),this.state==="initial"&&(this.state="active"),this._prevFrame=t}}}class s extends k{get cursor(){return this.value?0:1}get _value(){return this.cursor===0}constructor(t){super(t,!1),this.value=!!t.initialValue,this.on("value",()=>{this.value=this._value}),this.on("confirm",F=>{this.output.write(sisteransi.cursor.move(0,-1)),this.value=F,this.state="submit",this.close()}),this.on("cursor",()=>{this.value=!this.value})}}var a$1=Object.defineProperty,n$3=(C,t,F)=>t in C?a$1(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,l$3=(C,t,F)=>(n$3(C,typeof t!="symbol"?t+"":t,F),F);let c$1=class extends k{constructor(t){super(t,!1),l$3(this,"options"),l$3(this,"cursor",0);const{options:F}=t;this.options=Object.entries(F).flatMap(([E,B])=>[{value:E,group:!0,label:E},...B.map(A=>({...A,group:E}))]),this.value=[...t.initialValues??[]],this.cursor=Math.max(this.options.findIndex(({value:E})=>E===t.cursorAt),0),this.on("cursor",E=>{switch(E){case"left":case"up":this.cursor=this.cursor===0?this.options.length-1:this.cursor-1;break;case"down":case"right":this.cursor=this.cursor===this.options.length-1?0:this.cursor+1;break;case"space":this.toggleValue();break}})}getGroupItems(t){return this.options.filter(F=>F.group===t)}isGroupSelected(t){return this.getGroupItems(t).every(F=>this.value.includes(F.value))}toggleValue(){const t=this.options[this.cursor];if(t.group===!0){const F=t.value,E=this.getGroupItems(F);this.isGroupSelected(F)?this.value=this.value.filter(B=>E.findIndex(A=>A.value===B)===-1):this.value=[...this.value,...E.map(B=>B.value)],this.value=Array.from(new Set(this.value))}else{const F=this.value.includes(t.value);this.value=F?this.value.filter(E=>E!==t.value):[...this.value,t.value]}}};var o$2=Object.defineProperty,a=(C,t,F)=>t in C?o$2(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,l$2=(C,t,F)=>(a(C,typeof t!="symbol"?t+"":t,F),F);let u$2=class extends k{constructor(t){super(t,!1),l$2(this,"options"),l$2(this,"cursor",0),this.options=t.options,this.value=[...t.initialValues??[]],this.cursor=Math.max(this.options.findIndex(({value:F})=>F===t.cursorAt),0),this.on("key",F=>{F==="a"&&this.toggleAll()}),this.on("cursor",F=>{switch(F){case"left":case"up":this.cursor=this.cursor===0?this.options.length-1:this.cursor-1;break;case"down":case"right":this.cursor=this.cursor===this.options.length-1?0:this.cursor+1;break;case"space":this.toggleValue();break}})}get _value(){return this.options[this.cursor].value}toggleAll(){const t=this.value.length===this.options.length;this.value=t?[]:this.options.map(F=>F.value)}toggleValue(){const t=this.value.includes(this._value);this.value=t?this.value.filter(F=>F!==this._value):[...this.value,this._value]}};var u$1=Object.defineProperty,n$2=(C,t,F)=>t in C?u$1(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,e=(C,t,F)=>(n$2(C,typeof t!="symbol"?t+"":t,F),F);class m extends k{constructor({mask:t,...F}){super(F),e(this,"valueWithCursor",""),e(this,"_mask","\u2022"),this._mask=t??"\u2022",this.on("finalize",()=>{this.valueWithCursor=this.masked}),this.on("value",()=>{if(this.cursor>=this.value.length)this.valueWithCursor=`${this.masked}${i__default.inverse(i__default.hidden("_"))}`;else{const E=this.masked.slice(0,this.cursor),B=this.masked.slice(this.cursor);this.valueWithCursor=`${E}${i__default.inverse(B[0])}${B.slice(1)}`}})}get cursor(){return this._cursor}get masked(){return this.value.replaceAll(/./g,this._mask)}}var o$1=Object.defineProperty,n$1=(C,t,F)=>t in C?o$1(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,r=(C,t,F)=>(n$1(C,typeof t!="symbol"?t+"":t,F),F);class u extends k{constructor(t){super(t,!1),r(this,"options"),r(this,"cursor",0),this.options=t.options,this.cursor=this.options.findIndex(({value:F})=>F===t.initialValue),this.cursor===-1&&(this.cursor=0),this.changeValue(),this.on("cursor",F=>{switch(F){case"left":case"up":this.cursor=this.cursor===0?this.options.length-1:this.cursor-1;break;case"down":case"right":this.cursor=this.cursor===this.options.length-1?0:this.cursor+1;break}this.changeValue()})}get _value(){return this.options[this.cursor]}changeValue(){this.value=this._value.value}}var p=Object.defineProperty,l$1=(C,t,F)=>t in C?p(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,i=(C,t,F)=>(l$1(C,typeof t!="symbol"?t+"":t,F),F);class c extends k{constructor(t){super(t,!1),i(this,"options"),i(this,"cursor",0),this.options=t.options;const F=this.options.map(({value:[E]})=>E?.toLowerCase());this.cursor=Math.max(F.indexOf(t.initialValue),0),this.on("key",E=>{if(!F.includes(E))return;const B=this.options.find(({value:[A]})=>A?.toLowerCase()===E);B&&(this.value=B.value,this.state="submit",this.emit("submit"))})}}var l=Object.defineProperty,h=(C,t,F)=>t in C?l(C,t,{enumerable:!0,configurable:!0,writable:!0,value:F}):C[t]=F,o=(C,t,F)=>(h(C,typeof t!="symbol"?t+"":t,F),F);class n extends k{constructor(t){super(t),o(this,"valueWithCursor",""),this.on("finalize",()=>{this.value||(this.value=t.defaultValue),this.valueWithCursor=this.value}),this.on("value",()=>{if(this.cursor>=this.value.length)this.valueWithCursor=`${this.value}${i__default.inverse(i__default.hidden("_"))}`;else{const F=this.value.slice(0,this.cursor),E=this.value.slice(this.cursor);this.valueWithCursor=`${F}${i__default.inverse(E[0])}${E.slice(1)}`}})}get cursor(){return this._cursor}}exports.ConfirmPrompt=s,exports.GroupMultiSelectPrompt=c$1,exports.MultiSelectPrompt=u$2,exports.PasswordPrompt=m,exports.Prompt=k,exports.SelectKeyPrompt=c,exports.SelectPrompt=u,exports.TextPrompt=n,exports.block=block,exports.isCancel=isCancel,exports.updateSettings=updateSettings;
