...
const content = {
  en: {
    ...
    home: {
      ...
      description: 'Polished audio playback and waveform recording for React.',
      ...
      products: [
        {
          description: 'Polished playback, waveform rendering, multi-instance control, and a path from default UI to full composition.',
          href: '/player',
          label: 'Player',
        },
        {
          description: 'Waveform capture, file handoff, streaming session events, and recorder APIs that fit ASR workflows.',
          href: '/recorder',
          label: 'Recorder',
        },
      ],
    ...
    player: {
      ...
      title: 'A player that looks finished on day one and stays flexible when the product gets ambitious.',
      description: 'Start with a polished waveform player, then move into public primitives and hooks when the interface, orchestration, or business flow needs more control.',
      docsCta: 'Open Docs',
      ...
      quickStartAi: {
        ...
        title: 'Install once, start simple, then give AI the same public API.',
      },
      examples: {
        apiLabel: 'Public API',
        eyebrow: 'Examples & Customization',
        fitLabel: 'Best for',
        intro: 'Each example adds one layer of control. Start with a ready-made player, then move into branded surfaces, shared playback state, and hook-owned interfaces.',
        links: [
          { href: '/docs', label: 'Open docs' },
          { href: 'llms.txt', label: 'Open llms.txt' },
        ],
        ...
        items: [
          {
            ...
            step: 'Example 1',
            title: 'Ship a polished player in one import.',
          },
          {
            ...
            step: 'Example 2',
            title: 'Keep the engine, redesign the surface.',
          },
          {
            ...
            step: 'Example 3',
            title: 'Run multiple players without losing control.',
          },
          {
            api: '`useAudioPlayer()`',
            ...
            step: 'Example 4',
            title: 'Let playback become part of your workflow.',
          },
        ],
      },
      highlights: [
    ...
    recorder: {
      ...
      quickStartAi: {
        ...
        resourcesLabel: 'AI resources',
        title: 'Install once, record immediately, then point AI at the same recorder surface.',
      },
      examples: {
        apiLabel: 'Public API',
        eyebrow: 'Examples & Customization',
        fitLabel: 'Best for',
        intro: 'These examples move from default capture to richer recording workflows. Each step adds one new responsibility without leaving the public recorder model.',
        links: [
          { href: '/docs', label: 'Open docs' },
          { href: 'llms.txt', label: 'Open llms.txt' },
        ],
        ...
        items: [
          ...
          },
          {
            ...
            step: 'Example 3',
            title: 'Turn the recorder into a realtime stream.',
          },
          {
            ...
            step: 'Example 4',
            title: 'Make recording part of a larger product flow.',
          },
        ],
      },
      highlights: [
  ...
  zh: {
    ...
    player: {
      ...
      quickStartAi: {
        ...
        advancedDescription: '用简短 prompt 说明要做的播放器类型、场景和约束，再让 AI 读取 `llms.txt` 与文档。',
        ...
        eyebrow: 'Quick Start + AI Start',
        intro: '先安装并复制最小可运行代码；如果要交给 AI，就提供一条简短 prompt，并让它读取 `llms.txt`。',
        prompt: 'Use @waveform-audio/player to add a waveform audio player to this React app. Start with the default Player component. Read /llms.txt before writing code, and do not import internal source paths.',
        promptLabel: '简短 AI 提示词',
        promptNote: '这条 prompt 适合直接粘贴到编码助手里，然后由 `llms.txt` 补充可用组件、场景和约束。',
    ...
    recorder: {
      ...
      quickStartAi: {
        ...
        advancedDescription: '用简短 prompt 说明录音场景、文件或流式需求，再让 AI 读取 `llms.txt` 和文档里的录音说明。',
        advancedTitle: '展开 AI 指南',
        codeLabel: '最小录音示例',
        docsLinks: [
          { href: 'llms.txt', label: '打开 llms.txt' },
        ...
        eyebrow: 'Quick Start + AI Start',
        intro: '先安装并放入默认 Recorder；如果要交给 AI，再让它读取 `llms.txt`，理解文件输出和流式 ASR 的接入方式。',
        prompt: 'Use @waveform-audio/player to add a waveform recorder to this React app. Start with the default Recorder component. Read /llms.txt before writing code, and do not import internal source paths.',
        promptLabel: '简短 AI 提示词',
        promptNote: '这条 prompt 适合直接粘贴到编码助手里，再由 `llms.txt` 补充录音生命周期、Blob 输出和 chunk 处理方式。',
        resourcesLabel: 'AI 资源',
      ...
      examples: {
        ...
        eyebrow: '示例与定制',
        fitLabel: '适合场景',
        intro: '你可以直接使用默认波形录音器，也可以在需要文件交接、流式 ASR 或自定义录音界面时直接使用 hook 层。',
        links: [
          { href: '/docs', label: '打开文档' },
          { href: 'llms.txt', label: '打开 llms.txt' },
        ],
